...
T_BOARD_RELAY_TASKS: tuple[ScheduledTask, ...] = (
    ...
    ScheduledTask(
        ...
        task_kind="observation",
        owner_service="t-board-relay-service",
        schedule_hint="Day1 selection through Day3 close, every 30 minutes after five-minute data capture",
        frequency_hint="rolling_30m_live_model_result",
        reads_from=[
            "decision_t_relay.t_board_day1_candidate_v1",
            "decision_t_relay.t_board_day2_watch_snapshot_v1",
            "decision_t_relay.t_board_day2_entry_trigger_v1",
        ...
        is_official_publish=False,
        append_only=True,
        notes="Append-only 30-minute model-four result versions; front-end update time still follows the latest real data capture time.",
    ),
    ScheduledTask(
